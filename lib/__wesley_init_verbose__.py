...
print("\tWelcome to the Wesley Initiation File! \n\n\
...
print('\twalk_directory(directory)')
...
print('\twalk_directory_verbose(directory)')
...
print('\tclean_the_text(text, remove_numbers=False)')
...
print('\tdetermine_pdf_encoding(file)')
...
print('\tngram_list(text, n_gram_size)')
...
print('\tsimple_tokenize_by_sentences(text)')
...
print('\ttokenize_by_paragraphs(text)')
...
print('\tremove_stopwords(text, is_lower_case=False)')
...
print('\tsingle_word_search(search_word)')
...
print('\taccessed_created_modified(file)')
...
print('\tplot_top_ngrams_barchart(text, n=2)')    
...
print('\tplot_named_entity_barchart(text)')
...
print('\tfind_synonyms(search_term)')
...
print('\tget_synonyms(search_term)')
...
print('\tcosine_similarity(string_1, string_2)')
...
print('\tlevenshtein_distance(string_1, string_2)')
...
print('\tshow_wordcloud(data, title = None)')
...
print('\ttfidf_string_similarity_test(correct_string,test_string)')
